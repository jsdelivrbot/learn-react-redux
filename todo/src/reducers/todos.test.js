...
it("Todos are added with payload text and as incomplete", () => {
  ...
  testTodosReducer(initialState, expectedState, a.ADD_TODO, text);
});
...
it("A incomplete todo in the list can be marked as complete", () => {
  ...
  testTodosReducer(initialState, expectedState, a.TOGGLE_TODO_COMPLETE, index);
});
